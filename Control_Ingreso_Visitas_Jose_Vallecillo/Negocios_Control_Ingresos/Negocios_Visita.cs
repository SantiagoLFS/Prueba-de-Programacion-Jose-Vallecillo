...
namespace Negocios_Control_Ingresos
{
    public class Negocios_Visita
    {
        ...
        public static string Insert_visita(int id_visita, string nombre_visita, string apellido_visita) // llama el metodo insertar de la capa datos de la clase metodos_empleado
        {
            Metodos_Visita upd = new Metodos_Visita();
            Entidades_Visita vari = new Entidades_Visita();
            vari.Id_visita = id_visita;
        ...
        public static string Update_visita(int id_visita, string nombre_visita, string apellido_visita) // llama el metodo actualizar de la capa datos de la clase metodos_empleado
        {
            Metodos_Visita upd = new Metodos_Visita();
            Entidades_Visita vari = new Entidades_Visita();
            vari.Id_visita = id_visita;
